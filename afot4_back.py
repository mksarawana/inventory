...
#*********************************************identify the vrf status and name *********************************************
	...
	#	vrf_status = "True"
#		print("wdkJADKyagwd")
#	if bool(re.search('nnel',interface)) is True and  vrf_status == "True":
#		to_test = interface.replace("nnel","")
#		tel.write(("show run int "+interface+"\r").encode('ascii'))
 #               vrf_tun = tel.read_until("#".encode('ascii'))
#		vrf_name_find = re.findall('tunnel vrf (.+?)\n',vrf_tun.decode("utf-8"))
#	if vrf_name_find:
 #               print("vrf_namefind",vrf_name_find)
