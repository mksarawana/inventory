...
users_list = ['cdknoc']
default_router_password = 'l0nGl1vv3'
default_enable_password = 'C0mMAnd11Ne'
remarks = []
output_file_name = ""
vrf_name = ""
login_hosts = []
...
def auto_router_login():
	...
	#print("auto done")
		...
		#print(tel_res)
                ...
                password_output = tel.read_until('assword: '.encode('ascii'),2)
		...
		elif  bool(re.search("Authentication failed",login_status.decode("utf-8"))) is True or bool(re.search("#",password_output.decode("utf-8"))) is not True:
			print("Authentication issue")
			tel.write(('kaliapps\r').encode('ascii'))
			print(tel.read_until("password: ".encode('ascii'),2))
			tel.write("Cisco@jun2018\r".encode("ascii"))
